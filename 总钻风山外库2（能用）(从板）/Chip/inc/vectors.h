...
#undef VECTOR_067 //要先取消了，因为在 vectors.h 里默认是定义为 default_isr
#define VECTOR_067 USART3_IRQHandler //重新定义 63 号中断的 ISR： UART1
extern void USART3_IRQHandler();


#undef VECTOR_016 //要先取消了，因为在 vectors.h 里默认是定义为 default_isr
#define VECTOR_016 DMA0_IRQHandler //重新定义 63 号中断的 ISR： UART1
extern void DMA0_IRQHandler();


#undef VECTOR_103 //要先取消了，因为在 vectors.h 里默认是定义为 default_isr
#define VECTOR_103 PORTA_IRQHandler //重新定义 63 号中断的 ISR： UART1
extern void PORTA_IRQHandler();


#undef VECTOR_084 //要先取消了，因为在 vectors.h 里默认是定义为 default_isr
#define VECTOR_084 PIT0_IRQHandler //重新定义 63 号中断的 ISR： UART1
